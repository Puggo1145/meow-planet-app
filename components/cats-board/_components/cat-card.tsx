...
const CarCard: React.FC = () => {
    return (
        <View className="p-[2px] w-1/2">
            <View className="p-2 space-y-3 bg-white pb-4 rounded-md">
                {/* cat info */}
                ...
                <View className="w-full px-2 space-y-3">
                    <View className="flex-row items-center justify-between">
                        ...
                        <TouchableOpacity
                            className="flex-row items-center space-x-1 bg-primary px-4 py-2 rounded-full"
                        >
                            <Image source={icons.catFood} className="w-5 h-5 mr-1"/>
